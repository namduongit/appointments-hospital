...
public class AuthController {
    ...
    @PostMapping("/login")
    public ResponseEntity<RestResponse<LoginDTO.LoginRepsonse>> handlerLogin(
            @RequestBody LoginDTO.LoginRequest loginRequest) {

        LoginDTO.LoginRepsonse loginRepsonse = this.authService.handleLogin(loginRequest);

        RestResponse<LoginDTO.LoginRepsonse> response = new RestResponse<LoginDTO.LoginRepsonse>(HttpStatusResponse.OK, true,
                loginRepsonse, "Đăng nhập thành công", null);

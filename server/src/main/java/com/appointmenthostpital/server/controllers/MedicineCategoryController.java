...
public class MedicineCategoryController {
    ...
    @PostMapping("")
    public ResponseEntity<RestResponse<MedicineCategoryResponse>> handleCreateMedicineCategory(@RequestBody AdminMedicineCategoryDTO.CreateCategoryRequest request) {
